...
namespace FATURA.Blazor.Server {
    public partial class FATURABlazorApplication : BlazorApplication {
        public FATURABlazorApplication() {
            InitializeComponent();
        }
        ...
        private void FATURABlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
